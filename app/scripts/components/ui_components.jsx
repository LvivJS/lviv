...
var UiComp = React.createClass({
    ...
    return {
      images: {
        ...
        location: {
          ...
          imgClassName: 'ui__comp',
          d: 'M36.44 12.646C36.44 5.726 30.83.12 23.91.12S11.385 5.726 11.385 12.645c0 9.913 12.527 24.582 12.527 24.582s12.53-14.72 12.53-24.582zm-18.707-.748c0-3.413 2.767-6.18 6.18-6.18s6.178 2.767 6.178 6.18-2.766 6.18-6.178 6.18-6.18-2.767-6.18-6.18z',
          cx: '23.911',
          cy: '11.898',
          r: '3.038',
          d2: 'M30.994 32.87c-1.02 1.476-1.98 2.76-2.777 3.793 7.916.476 13.104 2.185 15.034 3.456-2.26 1.49-8.978 3.586-19.337 3.586-10.358 0-17.077-2.097-19.338-3.587 1.93-1.272 7.114-2.98 15.022-3.456-.8-1.032-1.76-2.316-2.78-3.792C7.074 33.832 0 36.712 0 40.118c0 4.19 10.707 7.588 23.913 7.588 13.207 0 23.912-3.396 23.912-7.588.002-3.407-7.08-6.29-16.83-7.248z'
        },
        time: {
          xmlns: 'http://www.w3.org/2000/svg',
          viewBox: '0 0 612 612',
          imgClassName: 'ui__comp',
          d: 'M306 0C136.992 0 0 136.992 0 306s136.992 306 306 306 306-137.012 306-306S475.008 0 306 0zm0 573.157C158.45 573.157 38.843 453.55 38.843 306 38.843 158.45 158.45 38.843 306 38.843c147.55 0 267.157 119.608 267.157 267.157 0 147.55-119.607 267.157-267.157 267.157zm19.125-457.202h-37.657l.593 209.782L420.14 438.69l23.313-32.877-118.325-99.22V115.954z'
        },
        facebook: {
          xmlns: 'http://www.w3.org/2000/svg',
          viewBox: '0 0 155.139 155.139',
          imgClassName: 'social_icons',
          pathClassName: 'social__icon',
          d: 'M89.584 155.14V84.377h23.742l3.562-27.585H89.584v-17.61c0-7.983 2.208-13.424 13.67-13.424l14.595-.007V1.08C115.324.752 106.66 0 96.576 0 75.52 0 61.104 12.853 61.104 36.452v20.34H37.29V84.38h23.814v70.76h28.48z'
        },
        twitter: {
          xmlns: 'http://www.w3.org/2000/svg',
          viewBox : '0 0 32 32',
  ...
  render: function() {
    ...
    return (
        <svg xmlns={imgObj.xmlns} viewBox={imgObj.viewBox} className={imgObj.imgClassName}>
          <path className={imgObj.pathClassName} d={imgObj.d}/>
          <circle cx={imgObj.cx} cy={imgObj.cy} r={imgObj.r}/>
          <path d={imgObj.d2}/>
        </svg>
    );
  }
